...
use ndarray::{Array2, ArrayBase, Dim, OwnedRepr, array, linalg};
...
fn test_quantum_teleportation(q0: Array2<c64>) -> (bool, Array2<c64>) {
    ...
    let new_state: Array2<c64> = linalg::kron(&linalg::kron(&to_qbit_vector(&false), &to_qbit_vector(&false)), &q0.clone());
...
mod tests {
    ...
    fn quantum_teleportation(){
        let q0 = array![[c64::new(0.8, 0.0)], [c64::new(0.0, -0.6)]];
